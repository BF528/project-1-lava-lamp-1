...
RLE_DataHistogram <- RLE_Data[-2:-2]
hist(RLE_DataHistogram, main="Histogram of the Median RLE", xlab= "Median RLE Values",)
NUSE_DataHistogram <- NUSE_Data[-2:-2]
hist(NUSE_DataHistogram, main="Histogram of the Median NUSE", xlab= "Median NUSE Values")
